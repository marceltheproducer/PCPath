...
echo ""
echo "Quick Actions available (right-click a file in Finder > Quick Actions):"
echo "  Copy as PC Path      Copies the selected file's path as a PC path"
echo "  Convert to Mac Path  Converts a PC path on your clipboard to a Mac path"
echo ""
